...
## Installation
The script has a storage file it needs to read and write. The location path is hardcoded to the user's documents folder in the '**scripts**' directory, you can change it or just place this script in your '**Documents**' directory in the directory '**scripts**'.
